...
def access_token(request):
    try:
        ...
        if(user_util.auto_login(request)):
            ...
            return AuthResponseInfo(access=str(refresh.access_token), refresh=str(refresh), isAdmin=user_util.is_admin(user_util.get_user()), userName=user_util.get_user().username).GenResponse()
