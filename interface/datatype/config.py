...
class iWebServerBaseConfig:
    ...
    IWEBSERVER_ERROR_CODE_EMAIL_ALREADY_PRESENCED = -107
    IWEBSERVER_ERROR_CODE_USERNAME_ALREADY_PRESENCED = -108
    IWEBSERVER_ERROR_CODE_PASSWORD_NOT_MATCH = -109
    IWEBSERVER_ERROR_CODE_CHANGING_ADMIN_USER = -200
